...
- Deterministic bases can synthesize data blocks: `repeat_byte`, `ramp_u8`, `triangle_u8`, `sine8_u8`, `fourier8_u8`.
...
- First bounded integer-only Fourier-style basis only.
